...
#manipulate the AIC so its QAIC and make comparisons to choose optimal model(s)
...
lagknots <- logknots(8, fun="ns", df=3) #change df 3 through 5
varknots.r=equalknots(mo.dlnmN$rainfall_obs, fun = "ns", df=3) #change df 3 through 5
varknots.t=equalknots(mo.dlnmN$temperature_obs, fun = "ns", df=3) #change df 3 through 5
...
nts.model <- glm(mo.dlnmN$incid_seaX ~ mo.cb.rain.nts + mo.cb.temp.nts + year, family = n.quasipoisson(), na.action=na.delete, mo.dlnmN)
...
plot(mo.pred.rain.iNTS, "slices", lag=c(2), col="orange2", ci.arg=list(col=topo.colors(70, alpha = 1)), ci.level=0.95, ci='b', lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="C")
plot(mo.pred.rain.iNTS, "slices", var=c(9), col="orange2", ci.arg=list(col=topo.colors(70, alpha = 1)), ci.level=0.95, ci='b', lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="D")
...
plot(mo.pred.temp.iNTS, "slices",lag=c(3), col="orange2", ci.arg=list(col=terrain.colors(70, alpha = 1)), ci.level=0.95, ci='b',lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="C")
plot(mo.pred.temp.iNTS, "slices",var=c(19), col="orange2", ci.arg=list(col=terrain.colors(70, alpha = 1)), ci.level=0.95, ci='b',lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="D")
