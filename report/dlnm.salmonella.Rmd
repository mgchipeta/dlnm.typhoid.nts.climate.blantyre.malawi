...
```{r predictRainNTS, results="hide", message=FALSE, warning=FALSE}
...
```{r predictTempNTS, results="hide", message=FALSE, warning=FALSE}
...
plot(nts.pred.temp, xlab="Lag (month)", "slices",var=c(29), col="orange2", ci.arg=list(col=terrain.colors(70, alpha = 1)), ci.level=0.95, ci='b',lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="D")
```
...
```{r devianceTYP, results="hide", message=FALSE, warning=FALSE, fig.width=10, fig.height=5, fig.align='center'}
	par(mfrow=c(1,3))
...
```{r predictRainTYP, results="hide", message=FALSE, warning=FALSE}
  ...
  plot(typ.pred.rain, xlab="Lag (month)", "slices", var=c(16), col="red2", ci.arg=list(col=topo.colors(70, alpha = 1)), ci.level=0.95,ci='b', lwd=4.5, ylab="RR of typhoid", cex.lab=1.1, cex.axis=1.1,main="D")
```

##### Plots of TYP predictions due to temperature
```{r predictTempTYP, results="hide", message=FALSE, warning=FALSE}
...
```{r validationCheck, results="hide", message=FALSE, warning=FALSE, fig.width=10, fig.height = 7, fig.align='center'}
	par(mfrow=c(3,4))
...
##### Plots of TYP predictions due to rainfall/temperature
```{r predictEstimates, results="hide", message=FALSE, warning=FALSE, fig.width=12, fig.height = 5, fig.align='center'}
...
nts.cb.rain[[l]] <- vector("list",length(27))
nts.cb.temp[[l]] <- vector("list",length(27))
typ.cb.rain1[[l]] <- vector("list",length(27))
typ.cb.temp[[l]] <- vector("list",length(27))
sort(mo.dlnmN$rainfall_obs, decreasing=FALSE)
sort(mo.dlnmN$temperature_obs, decreasing=FALSE)
sort(mo.dlnmT$rainfall_obs, decreasing=FALSE)
sort(mo.dlnmT$temperature_obs, decreasing=FALSE)
	...
	for(k in 3:5){
	  ...
	  nts.varknots.r=equalknots(mo.dlnmN$rainfall_obs, fun="ns", df=j)
	  nts.varknots.t=equalknots(mo.dlnmN$temperature_obs, fun="ns", df=k)
	  nts.cb.rain1[[l]] <- crossbasis(mo.dlnmN$rainfall_obs, lag=8, argvar=list(fun="ns", knots=nts.varknots.r), arglag=list(knots=nts.lagknots))
	  ...
	  typ.varknots.r=equalknots(mo.dlnmT$rainfall_obs, fun="ns", df=j)
	  typ.varknots.t=equalknots(mo.dlnmT$temperature_obs, fun="ns", df=k)
	  typ.cb.rain1[[l]] <- crossbasis(mo.dlnmT$rainfall_obs, lag=8, argvar=list(fun="ns", knots=typ.varknots.r), arglag=list(knots=typ.lagknots))
...
##### Formulate alternative sensitivity models and plot predictions of NTS
```{r sensitivityNTS, results="hide", message=FALSE, warning=FALSE, fig.width=10, fig.height=3, fig.align='center'}
  ...
  nts.cb.rain.s6 <- nts.cb.rain[[19]]; nts.cb.temp.s6 <- nts.cb.temp[[19]]
	...
	par(mfrow=c(2,6))
	plot(nts.pred.rain.s1,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="A")
	plot(nts.pred.rain.s2,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="C")
	plot(nts.pred.rain.s3,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="E")
	plot(nts.pred.rain.s4,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="G")
	plot(nts.pred.rain.s5,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="I")
	plot(nts.pred.rain.s6,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="K")
	
	plot(nts.pred.temp.s1,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="B")
	plot(nts.pred.temp.s2,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="D")
	plot(nts.pred.temp.s3,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="F")
	plot(nts.pred.temp.s4,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="H")
	plot(nts.pred.temp.s5,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="J")
	plot(nts.pred.temp.s6,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="L")
```

##### Formulate alternative sensitivity models and plot predictions of Typhoid
```{r sensitivityTyp, results="hide", message=FALSE, warning=FALSE, fig.width=10, fig.height = 3, fig.align='center'}
  typ.cb.rain.s1 <- typ.cb.rain1[[2]]; typ.cb.temp.s1 <- typ.cb.temp[[2]]
  typ.cb.rain.s2 <- typ.cb.rain1[[3]]; typ.cb.temp.s2 <- typ.cb.temp[[3]]
  typ.cb.rain.s3 <- typ.cb.rain1[[4]]; typ.cb.temp.s3 <- typ.cb.temp[[4]]
  typ.cb.rain.s4 <- typ.cb.rain1[[7]]; typ.cb.temp.s4 <- typ.cb.temp[[7]]
  typ.cb.rain.s5 <- typ.cb.rain1[[10]]; typ.cb.temp.s5 <- typ.cb.temp[[10]]
  typ.cb.rain.s6 <- typ.cb.rain1[[19]]; typ.cb.temp.s6 <- typ.cb.temp[[19]]

	typ.model.s1 <- glm(incid_seaX~typ.cb.rain.s1 + typ.cb.temp.s1 + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmT)
	typ.model.s2 <- glm(incid_seaX~typ.cb.rain.s2 + typ.cb.temp.s2 + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmT)
	typ.model.s3 <- glm(incid_seaX~typ.cb.rain.s3 + typ.cb.temp.s3 + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmT)
	typ.model.s4 <- glm(incid_seaX~typ.cb.rain.s4 + typ.cb.temp.s4 + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmT)
	typ.model.s5 <- glm(incid_seaX~typ.cb.rain.s5 + typ.cb.temp.s5 + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmT)
	typ.model.s6 <- glm(incid_seaX~typ.cb.rain.s6 + typ.cb.temp.s6 + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmT)
	
	typ.model.s1 <- update(typ.model.s1,.~.+Lag(residuals(typ.model.s1,type="deviance"),1))
	typ.model.s1 <- update(typ.model.s1,.~.+Lag(residuals(typ.model.s1,type="deviance"),3))#add residuals at lag 1
	typ.model.s2 <- update(typ.model.s2,.~.+Lag(residuals(typ.model.s2,type="deviance"),1)) #to correct for partial
	typ.model.s3 <- update(typ.model.s3,.~.+Lag(residuals(typ.model.s3,type="deviance"),1)) #autocorrelation
	typ.model.s4 <- update(typ.model.s4,.~.+Lag(residuals(typ.model.s4,type="deviance"),2)) 
	typ.model.s4 <- update(typ.model.s4,.~.+Lag(residuals(typ.model.s4,type="deviance"),1)) 
	typ.model.s5 <- update(typ.model.s5,.~.+Lag(residuals(typ.model.s5,type="deviance"),4)) 
	typ.model.s5 <- update(typ.model.s5,.~.+Lag(residuals(typ.model.s5,type="deviance"),4))
	typ.model.s5 <- update(typ.model.s5,.~.+Lag(residuals(typ.model.s5,type="deviance"),1))
	typ.model.s6 <- update(typ.model.s6,.~.+Lag(residuals(typ.model.s6,type="deviance"),1)) 

	typ.pred.rain.s1 <- crosspred(typ.cb.rain.s1, typ.model.s1, cen=0, by=0.2)
	typ.pred.rain.s2 <- crosspred(typ.cb.rain.s2, typ.model.s2, cen=0, by=0.2)
	typ.pred.rain.s3 <- crosspred(typ.cb.rain.s3, typ.model.s3, cen=0, by=0.2)
	typ.pred.rain.s4 <- crosspred(typ.cb.rain.s4, typ.model.s4, cen=0, by=0.2)
	typ.pred.rain.s5 <- crosspred(typ.cb.rain.s5, typ.model.s5, cen=0, by=0.2)
	typ.pred.rain.s6 <- crosspred(typ.cb.rain.s6, typ.model.s6, cen=0, by=0.2)
	
	typ.pred.temp.s1 <- crosspred(typ.cb.temp.s1, typ.model.s1, cen=23, by=0.2)
	typ.pred.temp.s2 <- crosspred(typ.cb.temp.s2, typ.model.s2, cen=23, by=0.2)
	typ.pred.temp.s3 <- crosspred(typ.cb.temp.s3, typ.model.s3, cen=23, by=0.2)
	typ.pred.temp.s4 <- crosspred(typ.cb.temp.s4, typ.model.s4, cen=23, by=0.2)
	typ.pred.temp.s5 <- crosspred(typ.cb.temp.s5, typ.model.s5, cen=23, by=0.2)
	typ.pred.temp.s6 <- crosspred(typ.cb.temp.s6, typ.model.s6, cen=23, by=0.2)
	
	par(mfrow=c(2,6))
	plot(typ.pred.rain.s1,"slices",var=c(9),col="red2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="A")
	plot(typ.pred.rain.s2,"slices",var=c(9),col="red2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="C")
	plot(typ.pred.rain.s3,"slices",var=c(9),col="red2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="E")
	plot(typ.pred.rain.s4,"slices",var=c(9),col="red2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="G")
	plot(typ.pred.rain.s5,"slices",var=c(9),col="red2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="I")
	plot(typ.pred.rain.s6,"slices",var=c(9),col="red2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="K")
	
	plot(typ.pred.temp.s1,"slices",var=c(19),col="red2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR oftyphoid",cex.lab=1.1,cex.axis=1.1,main="B")
	plot(typ.pred.temp.s2,"slices",var=c(19),col="red2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="D")
	plot(typ.pred.temp.s3,"slices",var=c(19),col="red2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="F")
	plot(typ.pred.temp.s4,"slices",var=c(19),col="red2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="H")
	plot(typ.pred.temp.s5,"slices",var=c(19),col="red2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="J")
	plot(typ.pred.temp.s6,"slices",var=c(19),col="red2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of typhoid",cex.lab=1.1,cex.axis=1.1,main="L")
```
