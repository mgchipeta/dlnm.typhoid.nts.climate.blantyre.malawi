...
```{r sensitivityPred, results="hide", message=FALSE, warning=FALSE}
	nts.model.s1 <- glm(incid_seaX~nts.cb.rain[[2]] + nts.cb.temp[[2]] + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
	nts.model.s2 <- glm(incid_seaX~nts.cb.rain[[3]] + nts.cb.temp[[3]] + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
	nts.model.s3 <- glm(incid_seaX~nts.cb.rain[[4]] + nts.cb.temp[[4]] + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
	nts.model.s4 <- glm(incid_seaX~nts.cb.rain[[7]] + nts.cb.temp[[7]] + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
	nts.model.s5 <- glm(incid_seaX~nts.cb.rain[[10]] + nts.cb.temp[[10]] + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
	nts.model.s6 <- glm(incid_seaX~nts.cb.rain[[19]] + nts.cb.temp[[19]] + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
	...
	nts.pred.rain.s1 <- crosspred(nts.cb.rain[[2]], nts.model.s1, cen=0, by=0.2)
	nts.pred.rain.s2 <- crosspred(nts.cb.rain[[3]], nts.model.s1, cen=0, by=0.2)
	nts.pred.rain.s3 <- crosspred(nts.cb.rain[[4]], nts.model.s1, cen=0, by=0.2)
	nts.pred.rain.s4 <- crosspred(nts.cb.rain[[7]], nts.model.s1, cen=0, by=0.2)
	nts.pred.rain.s5 <- crosspred(nts.cb.rain[[10]], nts.model.s1, cen=0, by=0.2)
	nts.pred.rain.s6 <- crosspred(nts.cb.rain[[19]], nts.model.s1, cen=0, by=0.2)
	
	nts.pred.temp.s1 <- crosspred(nts.cb.temp[[2]], nts.model.s1, cen=23, by=0.2)
	nts.pred.temp.s2 <- crosspred(nts.cb.temp[[3]], nts.model.s1, cen=23, by=0.2)
	nts.pred.temp.s3 <- crosspred(nts.cb.temp[[4]], nts.model.s1, cen=23, by=0.2)
	nts.pred.temp.s4 <- crosspred(nts.cb.temp[[7]], nts.model.s1, cen=23, by=0.2)
	nts.pred.temp.s5 <- crosspred(nts.cb.temp[[10]], nts.model.s1, cen=23, by=0.2)
	nts.pred.temp.s6 <- crosspred(nts.cb.temp[[19]], nts.model.s1, cen=23, by=0.2)
```
