...
##### Plots of seasonal-adjusted incidences
...
```{r message=FALSE, warning=FALSE, paged.print=FALSE, fig.align='center', fig.height=5, fig.width=10}
htmltools::tags$div(
...
```{r plotContourNTSR, message=FALSE, warning=FALSE, include=FALSE, results="hide"}
jpeg("nts.pred.rain.png", width=1384,height=1142)
plot(nts.pred.rain, "contour", key.title=title("NTS"), plot.title=title("B", xlab ="Rainfall (mm)", ylab = "Lag (month)", cex.lab=1.1, cex.axis=1.1))
dev.off()
```
...
plot(load.image("nts.pred.rain.png"), main="X")
plot(nts.pred.rain, "slices", xlab="Rainfall (mm)", lag=c(2), col="orange2", ci.arg=list(col=topo.colors(70, alpha = 1)), ci.level=0.95, ci='b', lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="C")
plot(nts.pred.rain, "slices", xlab="Month-lag (given 9 mm) ", var=c(9), col="orange2", ci.arg=list(col=topo.colors(70, alpha = 1)), ci.level=0.95, ci='b', lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="D")
```
...
plot(nts.pred.temp, xlab="Month-lag (given 19 °C)", "slices",var=c(19), col="orange2", ci.arg=list(col=terrain.colors(70, alpha = 1)), ci.level=0.95, ci='b',lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="D")
plot(nts.pred.temp, xlab="Month-lag (given 29 °C)", "slices",var=c(29), col="orange2", ci.arg=list(col=terrain.colors(70, alpha = 1)), ci.level=0.95, ci='b',lwd=4.5, ylab="RR of NTS", cex.lab=1.1, cex.axis=1.1,main="E")
```
...
```{r predictRainTYP, results="hide", message=FALSE, warning=FALSE}
	...
	plot(typ.pred.rain, xlab="Month-lag (given 9 mm)", "slices", var=c(9), col="red2", ci.arg=list(col=topo.colors(70, alpha = 1)), ci.level=0.95,ci='b', lwd=4.5, ylab="RR of typhoid", cex.lab=1.1, cex.axis=1.1,main="D")
  plot(typ.pred.rain, xlab="Month-lag (given 16 mm)", "slices", var=c(16), col="red2", ci.arg=list(col=topo.colors(70, alpha = 1)), ci.level=0.95,ci='b', lwd=4.5, ylab="RR of typhoid", cex.lab=1.1, cex.axis=1.1,main="E")
```
...
par(mfrow=c(3,4))
	...
	plot(typ.pred.temp, xlab="Month-lag (given 19 °C)", "slices", var=c(19), col="red2", ci.arg=list(col=terrain.colors(70, alpha = 1)), ci.level=0.95,ci='b', lwd=4.5, ylab="RR of typhoid", cex.lab=1.1, cex.axis=1.1,main="E")
	plot(typ.pred.temp, xlab="Month-lag (given 25 °C)", "slices", var=c(25), col="red2", ci.arg=list(col=terrain.colors(70, alpha = 1)), ci.level=0.95,ci='b', lwd=4.5, ylab="RR of typhoid", cex.lab=1.1, cex.axis=1.1,main="F")
```
...
```{r validationCheck, results="hide", message=FALSE, warning=FALSE, fig.width=10, fig.height = 7, fig.align='center'}
	...
	plot(matrix(mo.dlnmN$incid_seaX),matrix(predict(nts.model, type="response")), col=c("red2","gray2"),xlab="Predicted NTS incidence rate", ylab="Observed NTS incidence rate",pch=19,cex=0.8,cex.lab=1.2,cex.axis=1.2)
	legend("topleft", legend=c("observed", "predicted"), col=c("grey10", "orange2"), cex=0.8, pch=19)
	...
	plot(matrix(mo.dlnmT$incid_seaX),matrix(predict(typ.modelR, type="response")), col=c("red2","gray2"),xlab="Predicted typhoid incidence rate", ylab="Observed typhoid incidence rate",pch=19,cex=0.8,cex.lab=1.2,cex.axis=1.2)
	legend("topleft", legend=c("observed", "predicted"), col=c("grey10", "red2"), cex=0.8, pch=19)
	...
	plot(matrix(mo.dlnmT$incid_seaX),matrix(predict(typ.modelT, type="response")), col=c("red2","gray2"),xlab="Predicted typhoid incidence rate", ylab="Observed typhoid incidence rate",pch=19,cex=0.8,cex.lab=1.2,cex.axis=1.2)
	legend("topleft", legend=c("observed", "predicted"), col=c("grey10", "red2"), cex=0.8, pch=19)
...
```{r predictEstimates, fig.align='center', fig.width=12, message=FALSE, warning=FALSE}
	cbind(nts.pred.rain$matRRfit)["9",];cbind(nts.pred.rain$matRRlow)["9",];cbind(nts.pred.rain$matRRhigh)["9",]
  cbind(nts.pred.rain$matRRfit)["13",];cbind(nts.pred.rain$matRRlow)["13",];cbind(nts.pred.rain$matRRhigh)["13",]
	cbind(nts.pred.temp$matRRfit)["19",];cbind(nts.pred.temp$matRRlow)["19",];cbind(nts.pred.temp$matRRhigh)["19",]
	cbind(nts.pred.temp$matRRfit)["29",];cbind(nts.pred.temp$matRRlow)["29",];cbind(nts.pred.temp$matRRhigh)["29",]
	cbind(typ.pred.rain$matRRfit)["9",];cbind(typ.pred.rain$matRRlow)["9",];cbind(typ.pred.rain$matRRhigh)["9",]
	cbind(typ.pred.rain$matRRfit)["16",];cbind(typ.pred.rain$matRRlow)["16",];cbind(typ.pred.rain$matRRhigh)["16",]
	cbind(typ.pred.temp$matRRfit)["19",];cbind(typ.pred.temp$matRRlow)["19",];cbind(typ.pred.temp$matRRhigh)["19",]
	cbind(typ.pred.temp$matRRfit)["25",];cbind(typ.pred.temp$matRRlow)["25",];cbind(typ.pred.temp$matRRhigh)["25",]
