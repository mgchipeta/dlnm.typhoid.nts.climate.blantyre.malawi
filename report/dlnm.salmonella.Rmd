...
##### Vary degrees of freedom for sensitivity analyses of NTS predictions
```{r sensitivityDF, results="hide", message=FALSE, warning=FALSE}
CBtable <- data.frame(model.no=rep(NA,27), lag.df=rep(NA,27), fx1.df=rep(NA,27), fx2.df=rep(NA,27), 
                      nts.cbR=rep("",27), nts.cbT=rep("",27), typ.cbR=rep("",27), typ.cbT=rep("",27))
l=1
for(k in 3:5){
  for(j in 3:5){
    for(i in 3:5){
  ...
  CBtable[l,] <- c(l,i,j,k, nts.mo.cb.rain, nts.mo.cb.temp, typ.mo.cb.rain, typ.mo.cb.temp)
...
##### Formulate alternative sensitivity models and predictions of NTS
```{r sensitivityPred, results="hide", message=FALSE, warning=FALSE}
nts.model.s1 <- glm(incid_seaX~nts.cb.rain + nts.cb.temp + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
nts.model.s2 <- glm(incid_seaX~nts.cb.rain + nts.cb.temp + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
nts.model.s3 <- glm(incid_seaX~nts.cb.rain + nts.cb.temp + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
nts.model.s4 <- glm(incid_seaX~nts.cb.rain + nts.cb.temp + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
nts.model.s5 <- glm(incid_seaX~nts.cb.rain + nts.cb.temp + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)
nts.model.s6 <- glm(incid_seaX~nts.cb.rain + nts.cb.temp + year, family=quasipoisson(), na.action=na.exclude, mo.dlnmN)

nts.model.s1 <- update(nts.model.s1,.~.+Lag(residuals(nts.model.s1,type="deviance"),1)) #add residuals at lag 1
nts.model.s2 <- update(nts.model.s2,.~.+Lag(residuals(nts.model.s2,type="deviance"),1)) #add residuals at lag 1
nts.model.s3 <- update(nts.model.s3,.~.+Lag(residuals(nts.model.s3,type="deviance"),1)) #add residuals at lag 1
nts.model.s4 <- update(nts.model.s4,.~.+Lag(residuals(nts.model.s4,type="deviance"),1)) #add residuals at lag 1
nts.model.s5 <- update(nts.model.s5,.~.+Lag(residuals(nts.model.s5,type="deviance"),1)) #add residuals at lag 1
nts.model.s6 <- update(nts.model.s6,.~.+Lag(residuals(nts.model.s6,type="deviance"),1)) #add residuals at lag 1

nts.pred.rain.s1 <- crosspred(nts.cb.rain, nts.model.s1, cen=0, by=0.2)
nts.pred.rain.s2 <- crosspred(nts.cb.rain, nts.model.s1, cen=0, by=0.2)
nts.pred.rain.s3 <- crosspred(nts.cb.rain, nts.model.s1, cen=0, by=0.2)
nts.pred.rain.s4 <- crosspred(nts.cb.rain, nts.model.s1, cen=0, by=0.2)
nts.pred.rain.s5 <- crosspred(nts.cb.rain, nts.model.s1, cen=0, by=0.2)
nts.pred.rain.s6 <- crosspred(nts.cb.rain, nts.model.s1, cen=0, by=0.2)

nts.pred.temp.s1 <- crosspred(nts.cb.temp, nts.model.s1, cen=23, by=0.2)
nts.pred.temp.s2 <- crosspred(nts.cb.temp, nts.model.s1, cen=23, by=0.2)
nts.pred.temp.s3 <- crosspred(nts.cb.temp, nts.model.s1, cen=23, by=0.2)
nts.pred.temp.s4 <- crosspred(nts.cb.temp, nts.model.s1, cen=23, by=0.2)
nts.pred.temp.s5 <- crosspred(nts.cb.temp, nts.model.s1, cen=23, by=0.2)
nts.pred.temp.s6 <- crosspred(nts.cb.temp, nts.model.s1, cen=23, by=0.2)
```

##### Plots of sensitivity analysis
```{r sensitivityPlots, results="hide", message=FALSE, warning=FALSE}
par(mfrow=c(2,6))
...
plot(nts.pred.rain.s1,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="C")
plot(nts.pred.rain.s1,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="E")
plot(nts.pred.rain.s1,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="G")
plot(nts.pred.rain.s1,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="I")
plot(nts.pred.rain.s1,"slices",var=c(9),col="orange2",ci.arg=list(col=topo.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="K")
...
plot(nts.pred.temp.s1,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="D")
plot(nts.pred.temp.s1,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="F")
plot(nts.pred.temp.s1,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="H")
plot(nts.pred.temp.s1,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="J")
plot(nts.pred.temp.s1,"slices",var=c(19),col="orange2",ci.arg=list(col=terrain.colors(70,alpha=1)),ci.level=0.95,ci='b',lwd=4.5,ylab="RR of NTS",cex.lab=1.1,cex.axis=1.1,main="L")
```
