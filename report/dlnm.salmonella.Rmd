...
malawi.map <- rgdal::readOGR(curl("https://github.com/deusthindwa/dlnm.typhoid.nts.climate.blantyre.malawi.git/data/", "malawi_map"))
```
...
plots[[1]] <- YD1  # add each plot into plot list
plots[[2]] <- YD2 
plots[[3]] <- YD3
plots[[4]] <- YD4 

multipanel(plotlist = plots)
```
